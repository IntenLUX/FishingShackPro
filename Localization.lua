...
Special thanks to the following individuals for their translation assistance:
...
--@localization(locale="frFR", format="lua_additive_table",handle-unlocalized="english")@end
end
